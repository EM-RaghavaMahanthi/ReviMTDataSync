...
async def step_0_drop_duplicates_in_staging(account_id: str, engine):
    """
    Step 0: Drop duplicate CreditTransaction records in staging table (stg_order_lines_bulk) to clean data
    """
    logger.info(f"[STEP 0] Dropping duplicate CreditTransaction records in stg_order_lines_bulk staging table")
...
async def process_order_lines_credit(account_id: str, engine):
    """
    ...
    """
    logger.info(f"[process_order_lines_credit] Starting processing for account_id={account_id}")
