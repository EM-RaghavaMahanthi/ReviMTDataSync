...
import logging
from stg_to_main_bulk.customer_tags.default import process_customer_tags_default
from stg_to_main_bulk.customer_tags.assignments import process_customer_tag_assignments

logger = logging.getLogger(__name__)


async def process_customer_tags(account_id: str, engine):
    """
    Main orchestrator for customer_tags processing (tag definitions -> assignments).
    Neither sub-step is location-scoped.
    """
