...
try:
    ...
    try:
        ...
        from stg_db_services.order_lines.credit import process_order_lines_credit
        from stg_db_services.order_lines.membership import process_order_lines_membership
        from stg_db_services.order_lines.other import process_order_lines_other
